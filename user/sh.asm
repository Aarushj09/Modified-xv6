...
getcmd(char *buf, int nbuf)
{
  ...
  fprintf(2, "$ ");
      ...
      14:	34058593          	addi	a1,a1,832 # 1350 <malloc+0x116>
      18:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      64:	2f858593          	addi	a1,a1,760 # 1358 <malloc+0x11e>
      68:	4509                	li	a0,2
      6a:	00001097          	auipc	ra,0x1
      6e:	0e2080e7          	jalr	226(ra) # 114c <fprintf>
  exit(1);
      72:	4505                	li	a0,1
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9e:	2c650513          	addi	a0,a0,710 # 1360 <malloc+0x126>
...
00000000000000aa <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      ca:	25a70713          	addi	a4,a4,602 # 1320 <malloc+0xe6>
    ...
    panic("runcmd");
      ...
      e4:	28850513          	addi	a0,a0,648 # 1368 <malloc+0x12e>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     106:	26e58593          	addi	a1,a1,622 # 1370 <malloc+0x136>
     10a:	4509                	li	a0,2
  ...
  exit(0);
    ...
    runcmd(rcmd->cmd);
     ...
     152:	23258593          	addi	a1,a1,562 # 1380 <malloc+0x146>
     156:	4509                	li	a0,2
    ...
    break;
     ...
     1e8:	1ac50513          	addi	a0,a0,428 # 1390 <malloc+0x156>
...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     400:	08c98993          	addi	s3,s3,140 # 1488 <whitespace>
  ...
  switch(*s){
     ...
     43a:	0ae7f863          	bgeu	a5,a4,4ea <gettoken+0x10c>
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     44c:	04098993          	addi	s3,s3,64 # 1488 <whitespace>
     450:	0124fd63          	bgeu	s1,s2,46a <gettoken+0x8c>
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     490:	ffc98993          	addi	s3,s3,-4 # 1488 <whitespace>
     494:	00001a97          	auipc	s5,0x1
     498:	feca8a93          	addi	s5,s5,-20 # 1480 <symbols>
     49c:	0324f563          	bgeu	s1,s2,4c6 <gettoken+0xe8>
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     540:	f4c98993          	addi	s3,s3,-180 # 1488 <whitespace>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5b0:	e0cb8b93          	addi	s7,s7,-500 # 13b8 <malloc+0x17e>
  ...
  while(peek(ps, es, "<>")){
     ...
     5c2:	dda50513          	addi	a0,a0,-550 # 1398 <malloc+0x15e>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6aa:	d1a60613          	addi	a2,a2,-742 # 13c0 <malloc+0x186>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6da:	d0ab0b13          	addi	s6,s6,-758 # 13e0 <malloc+0x1a6>
  ...
  return ret;
     ...
     714:	cb850513          	addi	a0,a0,-840 # 13c8 <malloc+0x18e>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     772:	c6250513          	addi	a0,a0,-926 # 13d0 <malloc+0x196>
...
000000000000078c <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7ac:	c4060613          	addi	a2,a2,-960 # 13e8 <malloc+0x1ae>
     7b0:	85ce                	mv	a1,s3
     7b2:	854a                	mv	a0,s2
...
00000000000007fa <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     81c:	bd8a0a13          	addi	s4,s4,-1064 # 13f0 <malloc+0x1b6>
     820:	8652                	mv	a2,s4
     822:	85ca                	mv	a1,s2
     824:	8526                	mv	a0,s1
  ...
  if(peek(ps, es, ";")){
     ...
     852:	baa60613          	addi	a2,a2,-1110 # 13f8 <malloc+0x1be>
     856:	85ca                	mv	a1,s2
     858:	8526                	mv	a0,s1
...
00000000000008a2 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8b8:	b0c60613          	addi	a2,a2,-1268 # 13c0 <malloc+0x186>
  ...
  if(!peek(ps, es, ")"))
     ...
     8e8:	b2c60613          	addi	a2,a2,-1236 # 1410 <malloc+0x1d6>
     8ec:	85ca                	mv	a1,s2
     8ee:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     92a:	ada50513          	addi	a0,a0,-1318 # 1400 <malloc+0x1c6>
     92e:	fffff097          	auipc	ra,0xfffff
     932:	728080e7          	jalr	1832(ra) # 56 <panic>
    panic("syntax - missing )");
     936:	00001517          	auipc	a0,0x1
     93a:	ae250513          	addi	a0,a0,-1310 # 1418 <malloc+0x1de>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     966:	9d670713          	addi	a4,a4,-1578 # 1338 <malloc+0xfe>
...
00000000000009de <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a12:	a2260613          	addi	a2,a2,-1502 # 1430 <malloc+0x1f6>
     a16:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a48:	9f458593          	addi	a1,a1,-1548 # 1438 <malloc+0x1fe>
     a4c:	4509                	li	a0,2
     a4e:	00000097          	auipc	ra,0x0
     a52:	6fe080e7          	jalr	1790(ra) # 114c <fprintf>
    panic("syntax");
     a56:	00001517          	auipc	a0,0x1
     a5a:	97250513          	addi	a0,a0,-1678 # 13c8 <malloc+0x18e>
...
0000000000000a66 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a7c:	9d048493          	addi	s1,s1,-1584 # 1448 <malloc+0x20e>
     a80:	4589                	li	a1,2
     a82:	8526                	mv	a0,s1
    ...
    if(fd >= 3){
     a90:	4789                	li	a5,2
     a92:	fea7d7e3          	bge	a5,a0,a80 <main+0x1a>
      close(fd);
     a96:	00000097          	auipc	ra,0x0
     a9a:	37c080e7          	jalr	892(ra) # e12 <close>
  while(getcmd(buf, sizeof(buf)) >= 0){
     a9e:	00001497          	auipc	s1,0x1
     aa2:	9fa48493          	addi	s1,s1,-1542 # 1498 <buf.1162>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     aa6:	06300913          	li	s2,99
     aaa:	02000993          	li	s3,32
      if(chdir(buf+3) < 0)
     aae:	00001a17          	auipc	s4,0x1
     ab2:	9eda0a13          	addi	s4,s4,-1555 # 149b <buf.1162+0x3>
        fprintf(2, "cannot cd %s\n", buf+3);
     ab6:	00001a97          	auipc	s5,0x1
     aba:	99aa8a93          	addi	s5,s5,-1638 # 1450 <malloc+0x216>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b32:	61e080e7          	jalr	1566(ra) # 114c <fprintf>
     b36:	bf79                	j	ad4 <main+0x6e>
      runcmd(parsecmd(buf));
     b38:	00001517          	auipc	a0,0x1
     b3c:	96050513          	addi	a0,a0,-1696 # 1498 <buf.1162>
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
     ...
     eb8:	f56080e7          	jalr	-170(ra) # e0a <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
  if(sgn && xx < 0){
     ed2:	c299                	beqz	a3,ed8 <printint+0x14>
     ed4:	0005cd63          	bltz	a1,eee <printint+0x2a>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     ee4:	00000897          	auipc	a7,0x0
     ee8:	57c88893          	addi	a7,a7,1404 # 1460 <digits>
     eec:	a801                	j	efc <printint+0x38>
    x = -xx;
     eee:	40b005bb          	negw	a1,a1
     ef2:	2581                	sext.w	a1,a1
    neg = 1;
     ef4:	4305                	li	t1,1
    x = -xx;
     ef6:	b7dd                	j	edc <printint+0x18>
  }while((x /= base) != 0);
     ef8:	85be                	mv	a1,a5
    buf[i++] = digits[x % base];
     efa:	8836                	mv	a6,a3
     efc:	0018069b          	addiw	a3,a6,1
     f00:	02c5f7bb          	remuw	a5,a1,a2
     f04:	1782                	slli	a5,a5,0x20
     f06:	9381                	srli	a5,a5,0x20
     f08:	97c6                	add	a5,a5,a7
     f0a:	0007c783          	lbu	a5,0(a5)
     f0e:	00f70023          	sb	a5,0(a4)
  }while((x /= base) != 0);
     f12:	0705                	addi	a4,a4,1
     f14:	02c5d7bb          	divuw	a5,a1,a2
     f18:	fec5f0e3          	bgeu	a1,a2,ef8 <printint+0x34>
  if(neg)
     f1c:	00030b63          	beqz	t1,f32 <printint+0x6e>
    buf[i++] = '-';
     f20:	fd040793          	addi	a5,s0,-48
     f24:	96be                	add	a3,a3,a5
     f26:	02d00793          	li	a5,45
     f2a:	fef68823          	sb	a5,-16(a3)
     f2e:	0028069b          	addiw	a3,a6,2

  while(--i >= 0)
     f32:	02d05963          	blez	a3,f64 <printint+0xa0>
     f36:	89aa                	mv	s3,a0
     f38:	fc040793          	addi	a5,s0,-64
     f3c:	00d784b3          	add	s1,a5,a3
     f40:	fff78913          	addi	s2,a5,-1
     f44:	9936                	add	s2,s2,a3
     f46:	36fd                	addiw	a3,a3,-1
     f48:	1682                	slli	a3,a3,0x20
     f4a:	9281                	srli	a3,a3,0x20
     f4c:	40d90933          	sub	s2,s2,a3
    putc(fd, buf[i]);
     f50:	fff4c583          	lbu	a1,-1(s1)
     f54:	854e                	mv	a0,s3
     f56:	00000097          	auipc	ra,0x0
     f5a:	f4c080e7          	jalr	-180(ra) # ea2 <putc>
  while(--i >= 0)
     f5e:	14fd                	addi	s1,s1,-1
     f60:	ff2498e3          	bne	s1,s2,f50 <printint+0x8c>
}
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
  for(i = 0; fmt[i]; i++){
     f90:	0005c483          	lbu	s1,0(a1)
     f94:	18048d63          	beqz	s1,112e <vprintf+0x1bc>
     f98:	8aaa                	mv	s5,a0
     f9a:	8b32                	mv	s6,a2
     f9c:	00158913          	addi	s2,a1,1
  state = 0;
     fa0:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     fba:	4aab8b93          	addi	s7,s7,1194 # 1460 <digits>
     fbe:	a839                	j	fdc <vprintf+0x6a>
        putc(fd, c);
     fc0:	85a6                	mv	a1,s1
     fc2:	8556                	mv	a0,s5
     fc4:	00000097          	auipc	ra,0x0
     fc8:	ede080e7          	jalr	-290(ra) # ea2 <putc>
     fcc:	a019                	j	fd2 <vprintf+0x60>
    } else if(state == '%'){
     fce:	01498f63          	beq	s3,s4,fec <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
     fd2:	0905                	addi	s2,s2,1
     fd4:	fff94483          	lbu	s1,-1(s2)
     fd8:	14048b63          	beqz	s1,112e <vprintf+0x1bc>
    c = fmt[i] & 0xff;
     fdc:	0004879b          	sext.w	a5,s1
    if(state == 0){
    ...
    1000:	0ce78563          	beq	a5,a4,10ca <vprintf+0x158>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    1008:	0ee78c63          	beq	a5,a4,1100 <vprintf+0x18e>
        putc(fd, va_arg(ap, uint));
      } else if(c == '%'){
    100c:	11478663          	beq	a5,s4,1118 <vprintf+0x1a6>
        putc(fd, c);
      } else {
    ...
    1018:	e8e080e7          	jalr	-370(ra) # ea2 <putc>
        putc(fd, c);
    101c:	85a6                	mv	a1,s1
    101e:	8556                	mv	a0,s5
    1020:	00000097          	auipc	ra,0x0
    1024:	e82080e7          	jalr	-382(ra) # ea2 <putc>
      }
      state = 0;
    1028:	4981                	li	s3,0
    102a:	b765                	j	fd2 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 10, 1);
    102c:	008b0493          	addi	s1,s6,8
    1030:	4685                	li	a3,1
    1032:	4629                	li	a2,10
    1034:	000b2583          	lw	a1,0(s6)
    1038:	8556                	mv	a0,s5
    103a:	00000097          	auipc	ra,0x0
    103e:	e8a080e7          	jalr	-374(ra) # ec4 <printint>
    1042:	8b26                	mv	s6,s1
      state = 0;
    1044:	4981                	li	s3,0
    1046:	b771                	j	fd2 <vprintf+0x60>
        printint(fd, va_arg(ap, uint64), 10, 0);
    1048:	008b0493          	addi	s1,s6,8
    104c:	4681                	li	a3,0
    104e:	4629                	li	a2,10
    1050:	000b2583          	lw	a1,0(s6)
    1054:	8556                	mv	a0,s5
    1056:	00000097          	auipc	ra,0x0
    105a:	e6e080e7          	jalr	-402(ra) # ec4 <printint>
    105e:	8b26                	mv	s6,s1
      state = 0;
    1060:	4981                	li	s3,0
    1062:	bf85                	j	fd2 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 16, 0);
    1064:	008b0493          	addi	s1,s6,8
    1068:	4681                	li	a3,0
    106a:	4641                	li	a2,16
    106c:	000b2583          	lw	a1,0(s6)
    1070:	8556                	mv	a0,s5
    1072:	00000097          	auipc	ra,0x0
    1076:	e52080e7          	jalr	-430(ra) # ec4 <printint>
    107a:	8b26                	mv	s6,s1
      state = 0;
    107c:	4981                	li	s3,0
  ...
  putc(fd, '0');
    ...
    1096:	e10080e7          	jalr	-496(ra) # ea2 <putc>
  putc(fd, 'x');
    109a:	85ea                	mv	a1,s10
    109c:	8556                	mv	a0,s5
    109e:	00000097          	auipc	ra,0x0
    10a2:	e04080e7          	jalr	-508(ra) # ea2 <putc>
    10a6:	44c1                	li	s1,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    ...
    10b8:	dee080e7          	jalr	-530(ra) # ea2 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    10bc:	0992                	slli	s3,s3,0x4
    10be:	34fd                	addiw	s1,s1,-1
    10c0:	f4e5                	bnez	s1,10a8 <vprintf+0x136>
        printptr(fd, va_arg(ap, uint64));
    10c2:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    10c6:	4981                	li	s3,0
    10c8:	b729                	j	fd2 <vprintf+0x60>
        s = va_arg(ap, char*);
    10ca:	008b0993          	addi	s3,s6,8
    10ce:	000b3483          	ld	s1,0(s6)
        if(s == 0)
    10d2:	c085                	beqz	s1,10f2 <vprintf+0x180>
        while(*s != 0){
    10d4:	0004c583          	lbu	a1,0(s1)
    10d8:	c9a1                	beqz	a1,1128 <vprintf+0x1b6>
          putc(fd, *s);
    10da:	8556                	mv	a0,s5
    10dc:	00000097          	auipc	ra,0x0
    10e0:	dc6080e7          	jalr	-570(ra) # ea2 <putc>
          s++;
    10e4:	0485                	addi	s1,s1,1
        while(*s != 0){
    10e6:	0004c583          	lbu	a1,0(s1)
    10ea:	f9e5                	bnez	a1,10da <vprintf+0x168>
        s = va_arg(ap, char*);
    10ec:	8b4e                	mv	s6,s3
      state = 0;
    10ee:	4981                	li	s3,0
    10f0:	b5cd                	j	fd2 <vprintf+0x60>
          s = "(null)";
    10f2:	00000497          	auipc	s1,0x0
    10f6:	38648493          	addi	s1,s1,902 # 1478 <digits+0x18>
        while(*s != 0){
    10fa:	02800593          	li	a1,40
    10fe:	bff1                	j	10da <vprintf+0x168>
        putc(fd, va_arg(ap, uint));
    1100:	008b0493          	addi	s1,s6,8
    ...
    1120:	d86080e7          	jalr	-634(ra) # ea2 <putc>
      state = 0;
    1124:	4981                	li	s3,0
    1126:	b575                	j	fd2 <vprintf+0x60>
        s = va_arg(ap, char*);
    1128:	8b4e                	mv	s6,s3
      state = 0;
    112a:	4981                	li	s3,0
    112c:	b55d                	j	fd2 <vprintf+0x60>
    }
  }
}
...
fprintf(int fd, const char *fmt, ...)
{
  ...
  vprintf(fd, fmt, ap);
    ...
    116e:	e08080e7          	jalr	-504(ra) # f72 <vprintf>
}
...
printf(const char *fmt, ...)
{
  ...
  vprintf(1, fmt, ap);
    ...
    11a4:	dd2080e7          	jalr	-558(ra) # f72 <vprintf>
}
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    11be:	2d678793          	addi	a5,a5,726 # 1490 <freep>
    11c2:	639c                	ld	a5,0(a5)
    11c4:	a805                	j	11f4 <free+0x44>
  ...
  if(p + p->s.size == bp){
    ...
    11e6:	a099                	j	122c <free+0x7c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    11e8:	6398                	ld	a4,0(a5)
    11ea:	00e7e463          	bltu	a5,a4,11f2 <free+0x42>
    11ee:	00e6ea63          	bltu	a3,a4,1202 <free+0x52>
{
    11f2:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    11f4:	fed7fae3          	bgeu	a5,a3,11e8 <free+0x38>
    11f8:	6398                	ld	a4,0(a5)
    11fa:	00e6e463          	bltu	a3,a4,1202 <free+0x52>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    11fe:	fee7eae3          	bltu	a5,a4,11f2 <free+0x42>
  if(bp + bp->s.size == p->s.ptr){
    ...
    1212:	fae60ae3          	beq	a2,a4,11c6 <free+0x16>
    bp->s.ptr = p->s.ptr;
  ...
  if(p + p->s.size == bp){
    ...
    1226:	fae689e3          	beq	a3,a4,11d8 <free+0x28>
  } else
    p->s.ptr = bp;
    122a:	e394                	sd	a3,0(a5)
  freep = p;
    122c:	00000717          	auipc	a4,0x0
    1230:	26f73223          	sd	a5,612(a4) # 1490 <freep>
}
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    124e:	02051993          	slli	s3,a0,0x20
    1252:	0209d993          	srli	s3,s3,0x20
    1256:	09bd                	addi	s3,s3,15
    1258:	0049d993          	srli	s3,s3,0x4
    125c:	2985                	addiw	s3,s3,1
    125e:	0009891b          	sext.w	s2,s3
  if((prevp = freep) == 0){
    1262:	00000797          	auipc	a5,0x0
    1266:	22e78793          	addi	a5,a5,558 # 1490 <freep>
    126a:	6388                	ld	a0,0(a5)
    126c:	c515                	beqz	a0,1298 <malloc+0x5e>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1272:	03277f63          	bgeu	a4,s2,12b0 <malloc+0x76>
    1276:	8a4e                	mv	s4,s3
    1278:	0009871b          	sext.w	a4,s3
    127c:	6685                	lui	a3,0x1
    127e:	00d77363          	bgeu	a4,a3,1284 <malloc+0x4a>
    1282:	6a05                	lui	s4,0x1
    1284:	000a0a9b          	sext.w	s5,s4
  p = sbrk(nu * sizeof(Header));
    ...
    if(p == freep)
    128c:	00000497          	auipc	s1,0x0
    1290:	20448493          	addi	s1,s1,516 # 1490 <freep>
  if(p == (char*)-1)
    1294:	5b7d                	li	s6,-1
    1296:	a885                	j	1306 <malloc+0xcc>
    base.s.ptr = freep = prevp = &base;
    1298:	00000797          	auipc	a5,0x0
    129c:	26878793          	addi	a5,a5,616 # 1500 <base>
    12a0:	00000717          	auipc	a4,0x0
    12a4:	1ef73823          	sd	a5,496(a4) # 1490 <freep>
    12a8:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    12aa:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    12ae:	b7e1                	j	1276 <malloc+0x3c>
      if(p->s.size == nunits)
    12b0:	02e90b63          	beq	s2,a4,12e6 <malloc+0xac>
        p->s.size -= nunits;
    12b4:	4137073b          	subw	a4,a4,s3
    12b8:	c798                	sw	a4,8(a5)
        p += p->s.size;
    12ba:	1702                	slli	a4,a4,0x20
    ...
    12ca:	1ca73523          	sd	a0,458(a4) # 1490 <freep>
      return (void*)(p + 1);
    ...
    12ea:	bff1                	j	12c6 <malloc+0x8c>
  hp->s.size = nu;
    12ec:	01552423          	sw	s5,8(a0)
  free((void*)(hp + 1));
    12f0:	0541                	addi	a0,a0,16
    12f2:	00000097          	auipc	ra,0x0
    12f6:	ebe080e7          	jalr	-322(ra) # 11b0 <free>
  return freep;
    12fa:	6088                	ld	a0,0(s1)
      if((p = morecore(nunits)) == 0)
    12fc:	d979                	beqz	a0,12d2 <malloc+0x98>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    12fe:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    1300:	4798                	lw	a4,8(a5)
    1302:	fb2777e3          	bgeu	a4,s2,12b0 <malloc+0x76>
    if(p == freep)
    1306:	6098                	ld	a4,0(s1)
    1308:	853e                	mv	a0,a5
    130a:	fef71ae3          	bne	a4,a5,12fe <malloc+0xc4>
  p = sbrk(nu * sizeof(Header));
    130e:	8552                	mv	a0,s4
    1310:	00000097          	auipc	ra,0x0
    1314:	b62080e7          	jalr	-1182(ra) # e72 <sbrk>
  if(p == (char*)-1)
    1318:	fd651ae3          	bne	a0,s6,12ec <malloc+0xb2>
        return 0;
    131c:	4501                	li	a0,0
    131e:	bf55                	j	12d2 <malloc+0x98>
