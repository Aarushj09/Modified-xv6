...
main(int argc, char *argv[])
{
  ...
  14:	81858593          	addi	a1,a1,-2024 # 828 <malloc+0xe8>
  18:	4509                	li	a0,2
  ...
  50:	7f458593          	addi	a1,a1,2036 # 840 <malloc+0x100>
  54:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ee:	46e88893          	addi	a7,a7,1134 # 858 <digits>
 ...
 41e:	fec5f0e3          	bgeu	a1,a2,3fe <printint+0x34>
  if(neg)
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5fc:	27848493          	addi	s1,s1,632 # 870 <digits+0x18>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6c4:	1b878793          	addi	a5,a5,440 # 878 <freep>
 6c8:	639c                	ld	a5,0(a5)
 ...
 6f4:	00e6ea63          	bltu	a3,a4,708 <free+0x52>
{
 ...
 736:	14f73323          	sd	a5,326(a4) # 878 <freep>
}
 73a:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 76c:	11078793          	addi	a5,a5,272 # 878 <freep>
 770:	6388                	ld	a0,0(a5)
 ...
 796:	0e648493          	addi	s1,s1,230 # 878 <freep>
  if(p == (char*)-1)
 79a:	5b7d                	li	s6,-1
 79c:	a885                	j	80c <malloc+0xcc>
    base.s.ptr = freep = prevp = &base;
 79e:	00000797          	auipc	a5,0x0
 7a2:	0e278793          	addi	a5,a5,226 # 880 <base>
 7a6:	00000717          	auipc	a4,0x0
 7aa:	0cf73923          	sd	a5,210(a4) # 878 <freep>
 7ae:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7d0:	0aa73623          	sd	a0,172(a4) # 878 <freep>
      return (void*)(p + 1);
