...
printint(int fd, int xx, int base, int sgn)
{
 ...
 406:	47688893          	addi	a7,a7,1142 # 878 <digits>
 40a:	a801                	j	41a <printint+0x38>
    x = -xx;
 ...
 412:	4305                	li	t1,1
    x = -xx;
 414:	b7dd                	j	3fa <printint+0x18>
  }while((x /= base) != 0);
 416:	85be                	mv	a1,a5
    buf[i++] = digits[x % base];
 418:	8836                	mv	a6,a3
 41a:	0018069b          	addiw	a3,a6,1
 41e:	02c5f7bb          	remuw	a5,a1,a2
 422:	1782                	slli	a5,a5,0x20
 424:	9381                	srli	a5,a5,0x20
 426:	97c6                	add	a5,a5,a7
 428:	0007c783          	lbu	a5,0(a5)
 42c:	00f70023          	sb	a5,0(a4)
  }while((x /= base) != 0);
 430:	0705                	addi	a4,a4,1
 432:	02c5d7bb          	divuw	a5,a1,a2
 436:	fec5f0e3          	bgeu	a1,a2,416 <printint+0x34>
  if(neg)
 43a:	00030b63          	beqz	t1,450 <printint+0x6e>
    buf[i++] = '-';
 43e:	fd040793          	addi	a5,s0,-48
 442:	96be                	add	a3,a3,a5
 444:	02d00793          	li	a5,45
 448:	fef68823          	sb	a5,-16(a3)
 44c:	0028069b          	addiw	a3,a6,2

  while(--i >= 0)
 450:	02d05963          	blez	a3,482 <printint+0xa0>
 454:	89aa                	mv	s3,a0
 456:	fc040793          	addi	a5,s0,-64
 45a:	00d784b3          	add	s1,a5,a3
 45e:	fff78913          	addi	s2,a5,-1
 462:	9936                	add	s2,s2,a3
 464:	36fd                	addiw	a3,a3,-1
 466:	1682                	slli	a3,a3,0x20
 468:	9281                	srli	a3,a3,0x20
 46a:	40d90933          	sub	s2,s2,a3
    putc(fd, buf[i]);
 46e:	fff4c583          	lbu	a1,-1(s1)
 472:	854e                	mv	a0,s3
 474:	00000097          	auipc	ra,0x0
 478:	f4c080e7          	jalr	-180(ra) # 3c0 <putc>
  while(--i >= 0)
 47c:	14fd                	addi	s1,s1,-1
 47e:	ff2498e3          	bne	s1,s2,46e <printint+0x8c>
}
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4b2:	18048d63          	beqz	s1,64c <vprintf+0x1bc>
 4b6:	8aaa                	mv	s5,a0
 4b8:	8b32                	mv	s6,a2
 4ba:	00158913          	addi	s2,a1,1
  state = 0;
 4be:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
 ...
 4d8:	3a4b8b93          	addi	s7,s7,932 # 878 <digits>
 4dc:	a839                	j	4fa <vprintf+0x6a>
        putc(fd, c);
 4de:	85a6                	mv	a1,s1
 4e0:	8556                	mv	a0,s5
 4e2:	00000097          	auipc	ra,0x0
 4e6:	ede080e7          	jalr	-290(ra) # 3c0 <putc>
 4ea:	a019                	j	4f0 <vprintf+0x60>
    } else if(state == '%'){
 4ec:	01498f63          	beq	s3,s4,50a <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
 4f0:	0905                	addi	s2,s2,1
 4f2:	fff94483          	lbu	s1,-1(s2)
 4f6:	14048b63          	beqz	s1,64c <vprintf+0x1bc>
    c = fmt[i] & 0xff;
 ...
 51e:	0ce78563          	beq	a5,a4,5e8 <vprintf+0x158>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
 ...
 526:	0ee78c63          	beq	a5,a4,61e <vprintf+0x18e>
        putc(fd, va_arg(ap, uint));
      } else if(c == '%'){
 52a:	11478663          	beq	a5,s4,636 <vprintf+0x1a6>
        putc(fd, c);
      } else {
 ...
 536:	e8e080e7          	jalr	-370(ra) # 3c0 <putc>
        putc(fd, c);
 53a:	85a6                	mv	a1,s1
 53c:	8556                	mv	a0,s5
 53e:	00000097          	auipc	ra,0x0
 542:	e82080e7          	jalr	-382(ra) # 3c0 <putc>
      }
      state = 0;
 546:	4981                	li	s3,0
 ...
 578:	e6e080e7          	jalr	-402(ra) # 3e2 <printint>
 57c:	8b26                	mv	s6,s1
      state = 0;
 57e:	4981                	li	s3,0
 ...
 594:	e52080e7          	jalr	-430(ra) # 3e2 <printint>
 598:	8b26                	mv	s6,s1
      state = 0;
 59a:	4981                	li	s3,0
 ...
 5b4:	e10080e7          	jalr	-496(ra) # 3c0 <putc>
  putc(fd, 'x');
 5b8:	85ea                	mv	a1,s10
 5ba:	8556                	mv	a0,s5
 5bc:	00000097          	auipc	ra,0x0
 5c0:	e04080e7          	jalr	-508(ra) # 3c0 <putc>
 5c4:	44c1                	li	s1,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
 ...
 5dc:	34fd                	addiw	s1,s1,-1
 5de:	f4e5                	bnez	s1,5c6 <vprintf+0x136>
        printptr(fd, va_arg(ap, uint64));
 5e0:	f8843b03          	ld	s6,-120(s0)
      state = 0;
 5e4:	4981                	li	s3,0
 5e6:	b729                	j	4f0 <vprintf+0x60>
        s = va_arg(ap, char*);
 5e8:	008b0993          	addi	s3,s6,8
 5ec:	000b3483          	ld	s1,0(s6)
        if(s == 0)
 5f0:	c085                	beqz	s1,610 <vprintf+0x180>
        while(*s != 0){
 5f2:	0004c583          	lbu	a1,0(s1)
 5f6:	c9a1                	beqz	a1,646 <vprintf+0x1b6>
          putc(fd, *s);
 5f8:	8556                	mv	a0,s5
 ...
 608:	f9e5                	bnez	a1,5f8 <vprintf+0x168>
        s = va_arg(ap, char*);
 60a:	8b4e                	mv	s6,s3
      state = 0;
 60c:	4981                	li	s3,0
 60e:	b5cd                	j	4f0 <vprintf+0x60>
          s = "(null)";
 610:	00000497          	auipc	s1,0x0
 614:	28048493          	addi	s1,s1,640 # 890 <digits+0x18>
        while(*s != 0){
 618:	02800593          	li	a1,40
 61c:	bff1                	j	5f8 <vprintf+0x168>
        putc(fd, va_arg(ap, uint));
 ...
 63e:	d86080e7          	jalr	-634(ra) # 3c0 <putc>
      state = 0;
 642:	4981                	li	s3,0
 644:	b575                	j	4f0 <vprintf+0x60>
        s = va_arg(ap, char*);
 646:	8b4e                	mv	s6,s3
      state = 0;
 648:	4981                	li	s3,0
 64a:	b55d                	j	4f0 <vprintf+0x60>
    }
  }
}
...
fprintf(int fd, const char *fmt, ...)
{
 ...
 68c:	e08080e7          	jalr	-504(ra) # 490 <vprintf>
}
...
printf(const char *fmt, ...)
{
 ...
 6c2:	dd2080e7          	jalr	-558(ra) # 490 <vprintf>
}
...
free(void *ap)
{
 ...
 6dc:	1c078793          	addi	a5,a5,448 # 898 <freep>
 6e0:	639c                	ld	a5,0(a5)
 6e2:	a805                	j	712 <free+0x44>
 ...
 702:	e398                	sd	a4,0(a5)
 704:	a099                	j	74a <free+0x7c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 706:	6398                	ld	a4,0(a5)
 708:	00e7e463          	bltu	a5,a4,710 <free+0x42>
 70c:	00e6ea63          	bltu	a3,a4,720 <free+0x52>
{
 710:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 712:	fed7fae3          	bgeu	a5,a3,706 <free+0x38>
 716:	6398                	ld	a4,0(a5)
 718:	00e6e463          	bltu	a3,a4,720 <free+0x52>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 71c:	fee7eae3          	bltu	a5,a4,710 <free+0x42>
  if(bp + bp->s.size == p->s.ptr){
 ...
 730:	fae60ae3          	beq	a2,a4,6e4 <free+0x16>
    bp->s.ptr = p->s.ptr;
 ...
 744:	fae689e3          	beq	a3,a4,6f6 <free+0x28>
  } else
    p->s.ptr = bp;
 748:	e394                	sd	a3,0(a5)
  freep = p;
 74a:	00000717          	auipc	a4,0x0
 74e:	14f73723          	sd	a5,334(a4) # 898 <freep>
}
 752:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 76c:	02051993          	slli	s3,a0,0x20
 770:	0209d993          	srli	s3,s3,0x20
 774:	09bd                	addi	s3,s3,15
 776:	0049d993          	srli	s3,s3,0x4
 77a:	2985                	addiw	s3,s3,1
 77c:	0009891b          	sext.w	s2,s3
  if((prevp = freep) == 0){
 780:	00000797          	auipc	a5,0x0
 784:	11878793          	addi	a5,a5,280 # 898 <freep>
 788:	6388                	ld	a0,0(a5)
 78a:	c515                	beqz	a0,7b6 <malloc+0x5e>
 ...
 78c:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 78e:	4798                	lw	a4,8(a5)
 790:	03277f63          	bgeu	a4,s2,7ce <malloc+0x76>
 794:	8a4e                	mv	s4,s3
 796:	0009871b          	sext.w	a4,s3
 79a:	6685                	lui	a3,0x1
 79c:	00d77363          	bgeu	a4,a3,7a2 <malloc+0x4a>
 7a0:	6a05                	lui	s4,0x1
 7a2:	000a0a9b          	sext.w	s5,s4
 ...
 7ae:	0ee48493          	addi	s1,s1,238 # 898 <freep>
  if(p == (char*)-1)
 7b2:	5b7d                	li	s6,-1
 7b4:	a885                	j	824 <malloc+0xcc>
    base.s.ptr = freep = prevp = &base;
 ...
 7c8:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
 7cc:	b7e1                	j	794 <malloc+0x3c>
      if(p->s.size == nunits)
 7ce:	02e90b63          	beq	s2,a4,804 <malloc+0xac>
        p->s.size -= nunits;
 ...
 7e8:	0aa73a23          	sd	a0,180(a4) # 898 <freep>
      return (void*)(p + 1);
 ...
 804:	6398                	ld	a4,0(a5)
 806:	e118                	sd	a4,0(a0)
 808:	bff1                	j	7e4 <malloc+0x8c>
  hp->s.size = nu;
 80a:	01552423          	sw	s5,8(a0)
  free((void*)(hp + 1));
 80e:	0541                	addi	a0,a0,16
 810:	00000097          	auipc	ra,0x0
 814:	ebe080e7          	jalr	-322(ra) # 6ce <free>
  return freep;
 818:	6088                	ld	a0,0(s1)
      if((p = morecore(nunits)) == 0)
 81a:	d979                	beqz	a0,7f0 <malloc+0x98>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 81c:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 81e:	4798                	lw	a4,8(a5)
 820:	fb2777e3          	bgeu	a4,s2,7ce <malloc+0x76>
    if(p == freep)
 824:	6098                	ld	a4,0(s1)
 826:	853e                	mv	a0,a5
 828:	fef71ae3          	bne	a4,a5,81c <malloc+0xc4>
  p = sbrk(nu * sizeof(Header));
 82c:	8552                	mv	a0,s4
 82e:	00000097          	auipc	ra,0x0
 832:	b62080e7          	jalr	-1182(ra) # 390 <sbrk>
  if(p == (char*)-1)
 836:	fd651ae3          	bne	a0,s6,80a <malloc+0xb2>
        return 0;
 83a:	4501                	li	a0,0
 83c:	bf55                	j	7f0 <malloc+0x98>
