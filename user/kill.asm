...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3da:	0080                	addi	s0,sp,64
  ...
  neg = 0;
  if(sgn && xx < 0){
 3dc:	c299                	beqz	a3,3e2 <printint+0x14>
 3de:	0005cd63          	bltz	a1,3f8 <printint+0x2a>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
 ...
 3ee:	00000897          	auipc	a7,0x0
 3f2:	45a88893          	addi	a7,a7,1114 # 848 <digits>
 3f6:	a801                	j	406 <printint+0x38>
    x = -xx;
 ...
 3fe:	4305                	li	t1,1
    x = -xx;
 400:	b7dd                	j	3e6 <printint+0x18>
  }while((x /= base) != 0);
 402:	85be                	mv	a1,a5
    buf[i++] = digits[x % base];
 404:	8836                	mv	a6,a3
 406:	0018069b          	addiw	a3,a6,1
 40a:	02c5f7bb          	remuw	a5,a1,a2
 40e:	1782                	slli	a5,a5,0x20
 410:	9381                	srli	a5,a5,0x20
 412:	97c6                	add	a5,a5,a7
 414:	0007c783          	lbu	a5,0(a5)
 418:	00f70023          	sb	a5,0(a4)
  }while((x /= base) != 0);
 41c:	0705                	addi	a4,a4,1
 41e:	02c5d7bb          	divuw	a5,a1,a2
 422:	fec5f0e3          	bgeu	a1,a2,402 <printint+0x34>
  if(neg)
 426:	00030b63          	beqz	t1,43c <printint+0x6e>
    buf[i++] = '-';
 42a:	fd040793          	addi	a5,s0,-48
 42e:	96be                	add	a3,a3,a5
 430:	02d00793          	li	a5,45
 434:	fef68823          	sb	a5,-16(a3)
 438:	0028069b          	addiw	a3,a6,2

  while(--i >= 0)
 43c:	02d05963          	blez	a3,46e <printint+0xa0>
 440:	89aa                	mv	s3,a0
 442:	fc040793          	addi	a5,s0,-64
 446:	00d784b3          	add	s1,a5,a3
 44a:	fff78913          	addi	s2,a5,-1
 44e:	9936                	add	s2,s2,a3
 450:	36fd                	addiw	a3,a3,-1
 452:	1682                	slli	a3,a3,0x20
 454:	9281                	srli	a3,a3,0x20
 456:	40d90933          	sub	s2,s2,a3
    putc(fd, buf[i]);
 45a:	fff4c583          	lbu	a1,-1(s1)
 45e:	854e                	mv	a0,s3
 460:	00000097          	auipc	ra,0x0
 464:	f4c080e7          	jalr	-180(ra) # 3ac <putc>
  while(--i >= 0)
 468:	14fd                	addi	s1,s1,-1
 46a:	ff2498e3          	bne	s1,s2,45a <printint+0x8c>
}
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 49e:	18048d63          	beqz	s1,638 <vprintf+0x1bc>
 4a2:	8aaa                	mv	s5,a0
 4a4:	8b32                	mv	s6,a2
 4a6:	00158913          	addi	s2,a1,1
  state = 0;
 4aa:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
 ...
 4d2:	ede080e7          	jalr	-290(ra) # 3ac <putc>
 4d6:	a019                	j	4dc <vprintf+0x60>
    } else if(state == '%'){
 4d8:	01498f63          	beq	s3,s4,4f6 <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
 4dc:	0905                	addi	s2,s2,1
 4de:	fff94483          	lbu	s1,-1(s2)
 4e2:	14048b63          	beqz	s1,638 <vprintf+0x1bc>
    c = fmt[i] & 0xff;
 ...
 50a:	0ce78563          	beq	a5,a4,5d4 <vprintf+0x158>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
 ...
 512:	0ee78c63          	beq	a5,a4,60a <vprintf+0x18e>
        putc(fd, va_arg(ap, uint));
      } else if(c == '%'){
 516:	11478663          	beq	a5,s4,622 <vprintf+0x1a6>
        putc(fd, c);
      } else {
 ...
 522:	e8e080e7          	jalr	-370(ra) # 3ac <putc>
        putc(fd, c);
 526:	85a6                	mv	a1,s1
 528:	8556                	mv	a0,s5
 52a:	00000097          	auipc	ra,0x0
 52e:	e82080e7          	jalr	-382(ra) # 3ac <putc>
      }
      state = 0;
 532:	4981                	li	s3,0
 ...
 548:	e8a080e7          	jalr	-374(ra) # 3ce <printint>
 54c:	8b26                	mv	s6,s1
      state = 0;
 54e:	4981                	li	s3,0
 ...
 564:	e6e080e7          	jalr	-402(ra) # 3ce <printint>
 568:	8b26                	mv	s6,s1
      state = 0;
 56a:	4981                	li	s3,0
 ...
 580:	e52080e7          	jalr	-430(ra) # 3ce <printint>
 584:	8b26                	mv	s6,s1
      state = 0;
 586:	4981                	li	s3,0
 ...
 5a0:	e10080e7          	jalr	-496(ra) # 3ac <putc>
  putc(fd, 'x');
 5a4:	85ea                	mv	a1,s10
 5a6:	8556                	mv	a0,s5
 5a8:	00000097          	auipc	ra,0x0
 5ac:	e04080e7          	jalr	-508(ra) # 3ac <putc>
 5b0:	44c1                	li	s1,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
 ...
 5c8:	34fd                	addiw	s1,s1,-1
 5ca:	f4e5                	bnez	s1,5b2 <vprintf+0x136>
        printptr(fd, va_arg(ap, uint64));
 5cc:	f8843b03          	ld	s6,-120(s0)
      state = 0;
 5d0:	4981                	li	s3,0
 5d2:	b729                	j	4dc <vprintf+0x60>
        s = va_arg(ap, char*);
 5d4:	008b0993          	addi	s3,s6,8
 5d8:	000b3483          	ld	s1,0(s6)
        if(s == 0)
 5dc:	c085                	beqz	s1,5fc <vprintf+0x180>
        while(*s != 0){
 5de:	0004c583          	lbu	a1,0(s1)
 5e2:	c9a1                	beqz	a1,632 <vprintf+0x1b6>
          putc(fd, *s);
 5e4:	8556                	mv	a0,s5
 ...
 5f4:	f9e5                	bnez	a1,5e4 <vprintf+0x168>
        s = va_arg(ap, char*);
 5f6:	8b4e                	mv	s6,s3
      state = 0;
 5f8:	4981                	li	s3,0
 5fa:	b5cd                	j	4dc <vprintf+0x60>
          s = "(null)";
 5fc:	00000497          	auipc	s1,0x0
 600:	26448493          	addi	s1,s1,612 # 860 <digits+0x18>
        while(*s != 0){
 604:	02800593          	li	a1,40
 608:	bff1                	j	5e4 <vprintf+0x168>
        putc(fd, va_arg(ap, uint));
 60a:	008b0493          	addi	s1,s6,8
 ...
 62a:	d86080e7          	jalr	-634(ra) # 3ac <putc>
      state = 0;
 62e:	4981                	li	s3,0
 630:	b575                	j	4dc <vprintf+0x60>
        s = va_arg(ap, char*);
 632:	8b4e                	mv	s6,s3
      state = 0;
 634:	4981                	li	s3,0
 636:	b55d                	j	4dc <vprintf+0x60>
    }
  }
}
...
fprintf(int fd, const char *fmt, ...)
{
 ...
 678:	e08080e7          	jalr	-504(ra) # 47c <vprintf>
}
...
printf(const char *fmt, ...)
{
 ...
 6ae:	dd2080e7          	jalr	-558(ra) # 47c <vprintf>
}
...
free(void *ap)
{
 ...
 6c8:	1a478793          	addi	a5,a5,420 # 868 <freep>
 6cc:	639c                	ld	a5,0(a5)
 6ce:	a805                	j	6fe <free+0x44>
 ...
 6ee:	e398                	sd	a4,0(a5)
 6f0:	a099                	j	736 <free+0x7c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 6f2:	6398                	ld	a4,0(a5)
 6f4:	00e7e463          	bltu	a5,a4,6fc <free+0x42>
 6f8:	00e6ea63          	bltu	a3,a4,70c <free+0x52>
{
 6fc:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 6fe:	fed7fae3          	bgeu	a5,a3,6f2 <free+0x38>
 702:	6398                	ld	a4,0(a5)
 704:	00e6e463          	bltu	a3,a4,70c <free+0x52>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 708:	fee7eae3          	bltu	a5,a4,6fc <free+0x42>
  if(bp + bp->s.size == p->s.ptr){
 ...
 71c:	fae60ae3          	beq	a2,a4,6d0 <free+0x16>
    bp->s.ptr = p->s.ptr;
 ...
 730:	fae689e3          	beq	a3,a4,6e2 <free+0x28>
  } else
    p->s.ptr = bp;
 734:	e394                	sd	a3,0(a5)
  freep = p;
 736:	00000717          	auipc	a4,0x0
 73a:	12f73923          	sd	a5,306(a4) # 868 <freep>
}
 73e:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 768:	0009891b          	sext.w	s2,s3
  if((prevp = freep) == 0){
 76c:	00000797          	auipc	a5,0x0
 770:	0fc78793          	addi	a5,a5,252 # 868 <freep>
 774:	6388                	ld	a0,0(a5)
 776:	c515                	beqz	a0,7a2 <malloc+0x5e>
 ...
 778:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 77a:	4798                	lw	a4,8(a5)
 77c:	03277f63          	bgeu	a4,s2,7ba <malloc+0x76>
 780:	8a4e                	mv	s4,s3
 782:	0009871b          	sext.w	a4,s3
 786:	6685                	lui	a3,0x1
 788:	00d77363          	bgeu	a4,a3,78e <malloc+0x4a>
 78c:	6a05                	lui	s4,0x1
 78e:	000a0a9b          	sext.w	s5,s4
 ...
 79a:	0d248493          	addi	s1,s1,210 # 868 <freep>
  if(p == (char*)-1)
 79e:	5b7d                	li	s6,-1
 7a0:	a885                	j	810 <malloc+0xcc>
    base.s.ptr = freep = prevp = &base;
 7a2:	00000797          	auipc	a5,0x0
 7a6:	0ce78793          	addi	a5,a5,206 # 870 <base>
 7aa:	00000717          	auipc	a4,0x0
 7ae:	0af73f23          	sd	a5,190(a4) # 868 <freep>
 7b2:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 7b4:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
 7b8:	b7e1                	j	780 <malloc+0x3c>
      if(p->s.size == nunits)
 7ba:	02e90b63          	beq	s2,a4,7f0 <malloc+0xac>
        p->s.size -= nunits;
 ...
 7d4:	08a73c23          	sd	a0,152(a4) # 868 <freep>
      return (void*)(p + 1);
 ...
 7f0:	6398                	ld	a4,0(a5)
 7f2:	e118                	sd	a4,0(a0)
 7f4:	bff1                	j	7d0 <malloc+0x8c>
  hp->s.size = nu;
 7f6:	01552423          	sw	s5,8(a0)
  free((void*)(hp + 1));
 7fa:	0541                	addi	a0,a0,16
 7fc:	00000097          	auipc	ra,0x0
 800:	ebe080e7          	jalr	-322(ra) # 6ba <free>
  return freep;
 804:	6088                	ld	a0,0(s1)
      if((p = morecore(nunits)) == 0)
 806:	d979                	beqz	a0,7dc <malloc+0x98>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 808:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 80a:	4798                	lw	a4,8(a5)
 80c:	fb2777e3          	bgeu	a4,s2,7ba <malloc+0x76>
    if(p == freep)
 810:	6098                	ld	a4,0(s1)
 812:	853e                	mv	a0,a5
 814:	fef71ae3          	bne	a4,a5,808 <malloc+0xc4>
  p = sbrk(nu * sizeof(Header));
 818:	8552                	mv	a0,s4
 81a:	00000097          	auipc	ra,0x0
 81e:	b62080e7          	jalr	-1182(ra) # 37c <sbrk>
  if(p == (char*)-1)
 822:	fd651ae3          	bne	a0,s6,7f6 <malloc+0xb2>
        return 0;
 826:	4501                	li	a0,0
 828:	bf55                	j	7dc <malloc+0x98>
