...
fmtname(char *path)
{
  ...
  74:	ad090913          	addi	s2,s2,-1328 # b40 <buf.1136>
...
ls(char *path)
{
 ...
 132:	9aa50513          	addi	a0,a0,-1622 # ad8 <malloc+0x11c>
 136:	00000097          	auipc	ra,0x0
 13a:	7c6080e7          	jalr	1990(ra) # 8fc <printf>
      }
 ...
 170:	93c58593          	addi	a1,a1,-1732 # aa8 <malloc+0xec>
 174:	4509                	li	a0,2
 176:	00000097          	auipc	ra,0x0
 17a:	758080e7          	jalr	1880(ra) # 8ce <fprintf>
    return;
 17e:	b7e9                	j	148 <ls+0x8a>
    fprintf(2, "ls: cannot stat %s\n", path);
 180:	864a                	mv	a2,s2
 182:	00001597          	auipc	a1,0x1
 186:	93e58593          	addi	a1,a1,-1730 # ac0 <malloc+0x104>
 18a:	4509                	li	a0,2
 18c:	00000097          	auipc	ra,0x0
 190:	742080e7          	jalr	1858(ra) # 8ce <fprintf>
    close(fd);
 194:	8526                	mv	a0,s1
 ...
 1b0:	00a7fb63          	bgeu	a5,a0,1c6 <ls+0x108>
      printf("ls: path too long\n");
 1b4:	00001517          	auipc	a0,0x1
 1b8:	93450513          	addi	a0,a0,-1740 # ae8 <malloc+0x12c>
 1bc:	00000097          	auipc	ra,0x0
 1c0:	740080e7          	jalr	1856(ra) # 8fc <printf>
      break;
 ...
 1fc:	908a0a13          	addi	s4,s4,-1784 # b00 <malloc+0x144>
        printf("ls: cannot stat %s\n", buf);
 200:	00001a97          	auipc	s5,0x1
 204:	8c0a8a93          	addi	s5,s5,-1856 # ac0 <malloc+0x104>
 ...
 22a:	6d6080e7          	jalr	1750(ra) # 8fc <printf>
    while(read(fd, &de, sizeof(de)) == sizeof(de)){
 22e:	4641                	li	a2,16
 ...
 27c:	684080e7          	jalr	1668(ra) # 8fc <printf>
        continue;
...
main(int argc, char *argv[])
{
 ...
 28c:	1000                	addi	s0,sp,32
  ...
  if(argc < 2){
 28e:	4785                	li	a5,1
 290:	02a7d963          	bge	a5,a0,2c2 <main+0x40>
 ...
 2c6:	84e50513          	addi	a0,a0,-1970 # b10 <malloc+0x154>
...
atoi(const char *s)
{
 ...
 49c:	fee5f1e3          	bgeu	a1,a4,47e <atoi+0x1e>
  return n;
}
 4a0:	6422                	ld	s0,8(sp)
...
memmove(void *vdst, const void *vsrc, int n)
{
 ...
 4ae:	0800                	addi	s0,sp,16
  ...
  src = vsrc;
  if (src > dst) {
 4b0:	02b57663          	bgeu	a0,a1,4dc <memmove+0x32>
    while(n-- > 0)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 652:	0080                	addi	s0,sp,64
  ...
  neg = 0;
  if(sgn && xx < 0){
 654:	c299                	beqz	a3,65a <printint+0x14>
 656:	0005cd63          	bltz	a1,670 <printint+0x2a>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
 ...
 666:	00000897          	auipc	a7,0x0
 66a:	4b288893          	addi	a7,a7,1202 # b18 <digits>
 66e:	a801                	j	67e <printint+0x38>
    x = -xx;
 ...
 69a:	fec5f0e3          	bgeu	a1,a2,67a <printint+0x34>
  if(neg)
 69e:	00030b63          	beqz	t1,6b4 <printint+0x6e>
    buf[i++] = '-';
 ...
 6b0:	0028069b          	addiw	a3,a6,2
  ...
  while(--i >= 0)
 6b4:	02d05963          	blez	a3,6e6 <printint+0xa0>
 6b8:	89aa                	mv	s3,a0
 ...
 6dc:	f4c080e7          	jalr	-180(ra) # 624 <putc>
  while(--i >= 0)
 6e0:	14fd                	addi	s1,s1,-1
 6e2:	ff2498e3          	bne	s1,s2,6d2 <printint+0x8c>
}
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 73c:	3e0b8b93          	addi	s7,s7,992 # b18 <digits>
 740:	a839                	j	75e <vprintf+0x6a>
        putc(fd, c);
 742:	85a6                	mv	a1,s1
 744:	8556                	mv	a0,s5
 746:	00000097          	auipc	ra,0x0
 74a:	ede080e7          	jalr	-290(ra) # 624 <putc>
 ...
 79a:	e8e080e7          	jalr	-370(ra) # 624 <putc>
        putc(fd, c);
 79e:	85a6                	mv	a1,s1
 7a0:	8556                	mv	a0,s5
 7a2:	00000097          	auipc	ra,0x0
 7a6:	e82080e7          	jalr	-382(ra) # 624 <putc>
      }
      state = 0;
 7aa:	4981                	li	s3,0
 ...
 7c0:	e8a080e7          	jalr	-374(ra) # 646 <printint>
 7c4:	8b26                	mv	s6,s1
      state = 0;
 7c6:	4981                	li	s3,0
 ...
 7dc:	e6e080e7          	jalr	-402(ra) # 646 <printint>
 7e0:	8b26                	mv	s6,s1
      state = 0;
 7e2:	4981                	li	s3,0
 ...
 7f8:	e52080e7          	jalr	-430(ra) # 646 <printint>
 7fc:	8b26                	mv	s6,s1
      state = 0;
 7fe:	4981                	li	s3,0
 ...
 818:	e10080e7          	jalr	-496(ra) # 624 <putc>
  putc(fd, 'x');
 81c:	85ea                	mv	a1,s10
 81e:	8556                	mv	a0,s5
 820:	00000097          	auipc	ra,0x0
 824:	e04080e7          	jalr	-508(ra) # 624 <putc>
 828:	44c1                	li	s1,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
 ...
 862:	dc6080e7          	jalr	-570(ra) # 624 <putc>
          s++;
 ...
 878:	2bc48493          	addi	s1,s1,700 # b30 <digits+0x18>
        while(*s != 0){
 ...
 890:	d98080e7          	jalr	-616(ra) # 624 <putc>
 894:	8b26                	mv	s6,s1
      state = 0;
 896:	4981                	li	s3,0
 ...
 8a2:	d86080e7          	jalr	-634(ra) # 624 <putc>
      state = 0;
 8a6:	4981                	li	s3,0
...
free(void *ap)
{
 ...
 940:	1fc78793          	addi	a5,a5,508 # b38 <freep>
 944:	639c                	ld	a5,0(a5)
 ...
 970:	00e6ea63          	bltu	a3,a4,984 <free+0x52>
{
 ...
 9b2:	18f73523          	sd	a5,394(a4) # b38 <freep>
}
 9b6:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 9e8:	15478793          	addi	a5,a5,340 # b38 <freep>
 9ec:	6388                	ld	a0,0(a5)
 ...
 a12:	12a48493          	addi	s1,s1,298 # b38 <freep>
  if(p == (char*)-1)
 a16:	5b7d                	li	s6,-1
 a18:	a885                	j	a88 <malloc+0xcc>
    base.s.ptr = freep = prevp = &base;
 a1a:	00000797          	auipc	a5,0x0
 a1e:	13678793          	addi	a5,a5,310 # b50 <base>
 a22:	00000717          	auipc	a4,0x0
 a26:	10f73b23          	sd	a5,278(a4) # b38 <freep>
 a2a:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 a4c:	0ea73823          	sd	a0,240(a4) # b38 <freep>
      return (void*)(p + 1);
 ...
 a96:	b62080e7          	jalr	-1182(ra) # 5f4 <sbrk>
  if(p == (char*)-1)
