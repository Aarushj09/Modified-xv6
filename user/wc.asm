...
printint(int fd, int xx, int base, int sgn)
{
 ...
 50c:	0080                	addi	s0,sp,64
  ...
  neg = 0;
  if(sgn && xx < 0){
 50e:	c299                	beqz	a3,514 <printint+0x14>
 510:	0005cd63          	bltz	a1,52a <printint+0x2a>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
 ...
 520:	00000897          	auipc	a7,0x0
 524:	48888893          	addi	a7,a7,1160 # 9a8 <digits>
 528:	a801                	j	538 <printint+0x38>
    x = -xx;
 ...
 530:	4305                	li	t1,1
    x = -xx;
 532:	b7dd                	j	518 <printint+0x18>
  }while((x /= base) != 0);
 534:	85be                	mv	a1,a5
    buf[i++] = digits[x % base];
 536:	8836                	mv	a6,a3
 538:	0018069b          	addiw	a3,a6,1
 53c:	02c5f7bb          	remuw	a5,a1,a2
 540:	1782                	slli	a5,a5,0x20
 542:	9381                	srli	a5,a5,0x20
 544:	97c6                	add	a5,a5,a7
 546:	0007c783          	lbu	a5,0(a5)
 54a:	00f70023          	sb	a5,0(a4)
  }while((x /= base) != 0);
 54e:	0705                	addi	a4,a4,1
 550:	02c5d7bb          	divuw	a5,a1,a2
 554:	fec5f0e3          	bgeu	a1,a2,534 <printint+0x34>
  if(neg)
 558:	00030b63          	beqz	t1,56e <printint+0x6e>
    buf[i++] = '-';
 55c:	fd040793          	addi	a5,s0,-48
 560:	96be                	add	a3,a3,a5
 562:	02d00793          	li	a5,45
 566:	fef68823          	sb	a5,-16(a3)
 56a:	0028069b          	addiw	a3,a6,2

  while(--i >= 0)
 56e:	02d05963          	blez	a3,5a0 <printint+0xa0>
 572:	89aa                	mv	s3,a0
 574:	fc040793          	addi	a5,s0,-64
 578:	00d784b3          	add	s1,a5,a3
 57c:	fff78913          	addi	s2,a5,-1
 580:	9936                	add	s2,s2,a3
 582:	36fd                	addiw	a3,a3,-1
 584:	1682                	slli	a3,a3,0x20
 586:	9281                	srli	a3,a3,0x20
 588:	40d90933          	sub	s2,s2,a3
    putc(fd, buf[i]);
 58c:	fff4c583          	lbu	a1,-1(s1)
 590:	854e                	mv	a0,s3
 592:	00000097          	auipc	ra,0x0
 596:	f4c080e7          	jalr	-180(ra) # 4de <putc>
  while(--i >= 0)
 59a:	14fd                	addi	s1,s1,-1
 59c:	ff2498e3          	bne	s1,s2,58c <printint+0x8c>
}
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5f6:	3b6b8b93          	addi	s7,s7,950 # 9a8 <digits>
 5fa:	a839                	j	618 <vprintf+0x6a>
        putc(fd, c);
 5fc:	85a6                	mv	a1,s1
 5fe:	8556                	mv	a0,s5
 600:	00000097          	auipc	ra,0x0
 604:	ede080e7          	jalr	-290(ra) # 4de <putc>
 ...
 654:	e8e080e7          	jalr	-370(ra) # 4de <putc>
        putc(fd, c);
 658:	85a6                	mv	a1,s1
 65a:	8556                	mv	a0,s5
 65c:	00000097          	auipc	ra,0x0
 660:	e82080e7          	jalr	-382(ra) # 4de <putc>
      }
      state = 0;
 664:	4981                	li	s3,0
 ...
 67a:	e8a080e7          	jalr	-374(ra) # 500 <printint>
 67e:	8b26                	mv	s6,s1
      state = 0;
 680:	4981                	li	s3,0
 ...
 696:	e6e080e7          	jalr	-402(ra) # 500 <printint>
 69a:	8b26                	mv	s6,s1
      state = 0;
 69c:	4981                	li	s3,0
 ...
 6b2:	e52080e7          	jalr	-430(ra) # 500 <printint>
 6b6:	8b26                	mv	s6,s1
      state = 0;
 6b8:	4981                	li	s3,0
 ...
 6d2:	e10080e7          	jalr	-496(ra) # 4de <putc>
  putc(fd, 'x');
 6d6:	85ea                	mv	a1,s10
 6d8:	8556                	mv	a0,s5
 6da:	00000097          	auipc	ra,0x0
 6de:	e04080e7          	jalr	-508(ra) # 4de <putc>
 6e2:	44c1                	li	s1,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
 ...
 732:	29248493          	addi	s1,s1,658 # 9c0 <digits+0x18>
        while(*s != 0){
...
free(void *ap)
{
 ...
 7fa:	1d278793          	addi	a5,a5,466 # 9c8 <freep>
 7fe:	639c                	ld	a5,0(a5)
 ...
 82a:	00e6ea63          	bltu	a3,a4,83e <free+0x52>
{
 82e:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 830:	fed7fae3          	bgeu	a5,a3,824 <free+0x38>
 834:	6398                	ld	a4,0(a5)
 ...
 86c:	16f73023          	sd	a5,352(a4) # 9c8 <freep>
}
 870:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 8a2:	12a78793          	addi	a5,a5,298 # 9c8 <freep>
 8a6:	6388                	ld	a0,0(a5)
 ...
 8aa:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 8ac:	4798                	lw	a4,8(a5)
 8ae:	03277f63          	bgeu	a4,s2,8ec <malloc+0x76>
 8b2:	8a4e                	mv	s4,s3
 8b4:	0009871b          	sext.w	a4,s3
 8b8:	6685                	lui	a3,0x1
 8ba:	00d77363          	bgeu	a4,a3,8c0 <malloc+0x4a>
 8be:	6a05                	lui	s4,0x1
 ...
 8cc:	10048493          	addi	s1,s1,256 # 9c8 <freep>
  if(p == (char*)-1)
 8d0:	5b7d                	li	s6,-1
 8d2:	a885                	j	942 <malloc+0xcc>
    base.s.ptr = freep = prevp = &base;
 8d4:	00000797          	auipc	a5,0x0
 8d8:	2fc78793          	addi	a5,a5,764 # bd0 <base>
 8dc:	00000717          	auipc	a4,0x0
 8e0:	0ef73623          	sd	a5,236(a4) # 9c8 <freep>
 8e4:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 906:	0ca73323          	sd	a0,198(a4) # 9c8 <freep>
      return (void*)(p + 1);
 ...
 93a:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 93c:	4798                	lw	a4,8(a5)
 93e:	fb2777e3          	bgeu	a4,s2,8ec <malloc+0x76>
    if(p == freep)
 942:	6098                	ld	a4,0(s1)
 944:	853e                	mv	a0,a5
 ...
 950:	b62080e7          	jalr	-1182(ra) # 4ae <sbrk>
  if(p == (char*)-1)
